...
# Vendored from vllm-mlx (https://github.com/waybarrios/vllm-mlx),
# Apache-2.0. Modified: standalone import, no vllm_mlx dependency.
"""
...
The MTP scheduling logic lives in mtpserve/engine.py (decode_ids).
"""
